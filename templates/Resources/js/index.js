...
function updateQueriesOverTime() {
    $.getJSON("api/overTimeData?type=period&option[]=10mins", function (data) {
...
function updateQueryTypesPie() {
    $.getJSON("api/getQueryTypes", function (data) {
        if ("FTLnotrunning" in data) {
            return;
        }
...
function updateClientsOverTime() {
    $.getJSON("api/overTimeData?type=clients&option[]=getClientNames", function (data) {
        if ("FTLnotrunning" in data) {
            return;
        }
...
function updateForwardDestinationsPie() {
    $.getJSON("api/upstream", function (data) {
        if ("FTLnotrunning" in data) {
            return;
        }
...
function doughnutTooltip(tooltipLabel) {
    ...
    if (percentageTotalShown > 99.9) {        // All items shown
